...
private val LightMovieColors = lightMarvelpediaColors(
...
private val DarkMovieColors = darkMarvelpediaColors(
    material = darkColors(
        primary = Color.Black,
...
fun MarvelpediaTheme(
    ...
    CompositionLocalProvider(
        LocalMarvelpediaColors provides colors,
...
object MarvelpediaTheme {

    val colors: MarvelpediaColors
        @Composable
        get() = LocalMarvelpediaColors.current
